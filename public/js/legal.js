...
<p>Welcome to <strong>Monteriq Bank</strong> ("Monteriq", "we", "our", "us"). This Privacy Policy explains how we collect, use, disclose, and safeguard your personal information when you use our website, mobile application, and financial services (collectively, the "Services").</p>
...
<p>To exercise these rights, contact <a href="mailto:privacy@monteriq.com">privacy@monteriq.com</a>.</p>
...
<h2>11. Contact Us</h2>
<p>For privacy inquiries: <a href="mailto:privacy@monteriq.com">privacy@monteriq.com</a><br>
Monteriq Bank · Privacy Team · 123 Finance Street, Lagos, Nigeria.</p>
        `
    };
...
<p>By creating an account or using any feature of <strong>Monteriq Bank</strong> ("Monteriq", "we", "us"), you agree to be legally bound by these Terms of Service ("Terms"). If you do not agree, you may not use our Services.</p>

<h2>2. Eligibility</h2>
<p>To use Monteriq, you must:</p>
<ul>
...
<p>You are responsible for maintaining the confidentiality of your credentials (password, PIN, recovery phrase). You must notify us immediately at <a href="mailto:security@monteriq.com">security@monteriq.com</a> if you suspect unauthorised access. Monteriq is not liable for losses resulting from your failure to safeguard credentials.</p>
<p>Your <strong>12-word recovery phrase</strong> is the sole method to recover or reset your account. Store it offline in a secure location. Monteriq cannot retrieve this phrase on your behalf.</p>

<h2>4. Permitted Use</h2>
<p>You agree to use Monteriq solely for lawful purposes. You may not:</p>
<ul>
...
<p>All transactions are processed in real time. <strong>Completed transactions are final and irreversible</strong> except where required by applicable law. Fees (if any) are disclosed before transaction confirmation. Monteriq reserves the right to update fee schedules with 30 days' notice.</p>
...
<p>Loan disbursements are subject to credit assessment at Monteriq's sole discretion. Failure to repay may result in account suspension, credit reporting, and legal action. Interest rates and repayment schedules are disclosed in your loan agreement.</p>

<h2>9. Card Services</h2>
<p>Debit cards issued by Monteriq remain our property. Report lost or stolen cards immediately. You are liable for unauthorised transactions occurring before you report the card missing.</p>

<h2>10. Suspension & Termination</h2>
<p>Monteriq may suspend or terminate your account immediately if we detect fraud, legal violations, or activity that jeopardises our platform or other users. We will provide notice and recourse where legally required. You may close your account at any time by following the in-app account deletion process.</p>

<h2>11. Limitation of Liability</h2>
<p>To the maximum extent permitted by law, Monteriq's aggregate liability to you for any claim arising out of or related to these Terms or the Services shall not exceed the total fees paid by you to Monteriq in the 12 months preceding the claim. We are not liable for indirect, incidental, or consequential damages.</p>
...
<p>These Terms are governed by the laws of Nigeria (or the jurisdiction in which Monteriq Bank is registered) without regard to conflict-of-law principles.</p>
...
<h2>15. Contact</h2>
<p>Legal inquiries: <a href="mailto:legal@monteriq.com">legal@monteriq.com</a><br>
Monteriq Bank · Legal Department · 123 Finance Street, Lagos, Nigeria.</p>
        `
    };
