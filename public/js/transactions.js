...
const TxPage = (() => {
    ...
    async function downloadReceipt(txId) {
        ...
        try {
            ...
            doc.setFontSize(9);
            doc.setTextColor(255, 255, 255);
            doc.text('Monteriq Bank  •  support@monteriq.com  •  monteriq.com', W / 2, pH - 16, { align: 'center' });

            const ref  = t.transaction_reference || t.id.slice(0, 8);
            doc.save(`monteriq-receipt-${ref}.pdf`);
    ...
    async function exportStatement() {
        ...
        try {
            ...
            const addHeader = () => {
                ...
                doc.setFontSize(16);
                doc.setTextColor(255, 255, 255);
                doc.text('Monteriq Bank  —  Transaction Statement', 30, 32);
                doc.setFont('helvetica', 'normal');
                doc.setFontSize(9);
            ...
            doc.save(`monteriq-statement-${currentUser.first_name}-${dateStr}.pdf`);
